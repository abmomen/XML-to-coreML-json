...
def convert(xml_files, json_file):
    ...
    for xml_file in xml_files:
        ...
        for obj in get(root, "object"):
            ...
            annotations_dict.append({"label": category, "coordinates": {"x": xmin, "y": ymin, "width": o_width, "height": o_height}})
            bnd_id = bnd_id + 1
           
        json_dict.append({"image": image_id, "annotations": annotations_dict})
        annotations_dict = []
